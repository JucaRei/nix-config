...
with lib.excalibur; let
  cfg = config.excalibur.desktop.gnome;
...
in
{
  options.excalibur.desktop.gnome = with types; {
    enable =
      mkBoolOpt false "Whether or not to use Gnome as the desktop environment.";
    wallpaper = {
      light =
        mkOpt (oneOf [ str package ])
          pkgs.excalibur.wallpapers.nord-rainbow-light-nix
          "The light wallpaper to use.";
      dark =
        mkOpt (oneOf [ str package ])
          pkgs.excalibur.wallpapers.nord-rainbow-dark-nix
        ...
        nested-default-attrs {
          "org/gnome/shell" = {
            ...
            favorite-apps =
              ...
              ++ optional config.excalibur.apps.firefox.enable "firefox.desktop"
              ++ optional config.excalibur.apps.vscode.enable "code.desktop";
            #              ++ optional config.excalibur.desktop.addons.foot.enable "foot.desktop"
            #              ++ optional config.excalibur.apps.logseq.enable "logseq.desktop"
            #              ++ optional config.excalibur.apps.discord.enable "discord.desktop"
            #              ++ optional config.excalibur.apps.element.enable "element-desktop.desktop"
            #              ++ optional config.excalibur.apps.steam.enable "steam.desktop";
          };
          ...
          "org/gnome/shell/extensions/Logo-menu" = {
            ...
            menu-button-terminal =
              if config.excalibur.desktop.addons.term.enable
              then lib.getExe config.excalibur.desktop.addons.term.pkg
